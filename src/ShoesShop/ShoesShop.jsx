...
const ShoesShop = () => {
  ...
  return (
    <div>
      <h1 className="title my-5 text-4xl text-red-500 font-bold">Shoes Shop</h1>
      <h3 className="title2 text-xl my-4">Danh sách sản phẩm</h3>
      {/* <Detail detailProduct={detailProduct} /> */}

      <div className="grid grid-cols-3 text-left gap-5 my-10">
        {ListShoes()}
      </div>
      <ModalShoes
        openModal={openModal}
